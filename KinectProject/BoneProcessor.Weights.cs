                ...
                foreach (var bone in limbDataSkeleton.bones)
                {
                    switch (bone.boneHash)
                    {
                        case 35:    // head, shoulder center
                            ProcessBoneWeights(bone, new List<BonePixels> { GetBonePixelsDataFromBoneDictionary(130), GetBonePixelsDataFromBoneDictionary(66) }); break;
                        case 152:   // arms
                            ProcessBoneWeights(bone, new List<BonePixels> { GetBonePixelsDataFromBoneDictionary(130), GetBonePixelsDataFromBoneDictionary(18), GetBonePixelsDataFromBoneDictionary(35) }); break;
                        case 84:
                            ProcessBoneWeights(bone, new List<BonePixels> { GetBonePixelsDataFromBoneDictionary(66), GetBonePixelsDataFromBoneDictionary(18), GetBonePixelsDataFromBoneDictionary(35) }); break;
                        case 169:
                            ProcessBoneWeights(bone, new List<BonePixels> { GetBonePixelsDataFromBoneDictionary(186) }); break;
                        case 101:
                            ProcessBoneWeights(bone, new List<BonePixels> { GetBonePixelsDataFromBoneDictionary(118) }); break;
                        case 272:   // legs
                            ProcessBoneWeights(bone, new List<BonePixels> { GetBonePixelsDataFromBoneDictionary(256), GetBonePixelsDataFromBoneDictionary(192), GetBonePixelsDataFromBoneDictionary(220) }); break;
                        case 305:
                            ProcessBoneWeights(bone, new List<BonePixels> { GetBonePixelsDataFromBoneDictionary(242) }); break;
                        case 220:
                            ProcessBoneWeights(bone, new List<BonePixels> { GetBonePixelsDataFromBoneDictionary(192), GetBonePixelsDataFromBoneDictionary(256), GetBonePixelsDataFromBoneDictionary(272) }); break;
                        case 237:
                            ProcessBoneWeights(bone, new List<BonePixels> { GetBonePixelsDataFromBoneDictionary(254) }); break;
                    }
                }
            }
        }
